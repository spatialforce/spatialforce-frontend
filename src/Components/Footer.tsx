...
const orgJsonLd = {
  ...
  contactPoint: {
    ...
    email: "gis@spatialforce.co.zw",
    areaServed: "ZW",
    availableLanguage: "en",
  },
  sameAs: [
    "https://www.linkedin.com/company/spatial-force", // update / remove if needed
  ],
};
      ...
      <div className="sf3-container">
        ...
        <div className="sf3-grid">
          ...
          <section className="sf3-col" aria-labelledby="sf3-about">
            <h3 id="sf3-about" className="sf3-heading">
              About Spatial Force
            </h3>
          ...
          <nav
            className="sf3-col"
            aria-labelledby="sf3-links"
            role="navigation"
          >
            <h3 id="sf3-links" className="sf3-heading">
              Quick Links
            </h3>
            <ul className="sf3-list">
              <li>
                <Link to="/articles-and-projects" className="sf3-link">
                  GIS Articles &amp; Projects
                </Link>
              </li>
              <li>
                <Link to="/services2" className="sf3-link">
                  Geospatial Services
                </Link>
              </li>
              <li>
                <Link to="/bookings" className="sf3-link">
                  Project Bookings
                </Link>
              </li>
              <li>
                <Link to="/about" className="sf3-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="sf3-link">
                  Contact Spatial Force
                </Link>
              </li>
            </ul>
          </nav>
          ...
          <section className="sf3-col" aria-labelledby="sf3-services">
            <h3 id="sf3-services" className="sf3-heading">
              Our Services
            </h3>
        ...
        <div className="sf3-bottom">
          <p className="sf3-copy">
            &copy; {new Date().getFullYear()} Spatial Force Geospatial Solutions.
            All Rights Reserved.
          </p>
          <p className="sf3-legal">
            <Link to="/privacy" className="sf3-legal-link">
              Privacy Policy
            </Link>
            <span aria-hidden="true"> • </span>
            <Link to="/terms" className="sf3-legal-link">
              Terms &amp; Conditions
            </Link>
          </p>
        </div>
