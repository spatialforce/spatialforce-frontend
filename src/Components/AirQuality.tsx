...
const AirQuality: React.FC = () => {
  ...
  return (
    <div className={`no2-page gas-${selectedGas.toLowerCase()}`}>
      <Helmet>
      <title>Bulawayo Air Quality Map | NO₂, CH₄, CO & O₃ Dashboard | SpatialForce</title>
      <meta
        name="description"
        content="Interactive air quality map for Bulawayo showing NO₂, CH₄, CO and ozone patterns by ward. Explore hotspots, exposure and wind-driven plumes with Sentinel-5P data."
      />
      <meta
        name="keywords"
        content="Bulawayo air quality map, NO2 CH4 CO ozone Bulawayo, Sentinel-5P Bulawayo, air pollution Bulawayo wards, SpatialForce air quality dashboard"
      />
      <link
        rel="canonical"
        href="https://spatialforce.co.zw/air-quality"
      />

      {/* Open Graph (for sharing) */}
      <meta property="og:title" content="Bulawayo Air Quality Dashboard | SpatialForce" />
      <meta
        property="og:description"
        content="Explore Bulawayo's air pollution hotspots using NO₂, CH₄, CO and O₃ from Sentinel-5P, mapped by ward with exposure indices."
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://spatialforce.co.zw/air-quality"
      />

      {/* Twitter Card */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Bulawayo Air Quality Dashboard | SpatialForce" />
      <meta
        name="twitter:description"
        content="Ward-level air quality analytics for Bulawayo with NO₂, CH₄, CO and O₃ layers."
      />
      <meta
        name="twitter:image"
        content="https://spatialforce.co.zw/images/air-quality-bulawayo-featured.jpg"
      />
    </Helmet>
      <div
